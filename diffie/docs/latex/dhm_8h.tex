...
\begin{DoxyCompactList}\small\item\em bit width of public modulus \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em size of public modulus in bytes \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em bit width of private exponent(s) \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em size of private exponent(s) in bytes \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em size of unique session ID token \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em size of a SHA2-\/224 hash \end{DoxyCompactList}\end{DoxyCompactItemize}
